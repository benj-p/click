...
d_3 = Card.create({deck: europe, question: 'Norway is part of the European Union.', correct_answer: "False" , wrong_answer: "True", resource: r5})
...
d_7 = Card.create({deck: europe, question: 'Per capita, Sweden has the most McDonalds in Europe ', correct_answer: "True" , wrong_answer: "False", resource: r8})
